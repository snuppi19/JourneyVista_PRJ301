...
<html>
    ...
    <section class="contact-us" id="contact-section">
        <form id="contact" action="createhelp" method="post">
            ...
            <div class="inputField">
                ...
                <input type="name" name="name" id="name" value="${requestScope.user.fullname}" placeholder="Your name" autocomplete="on" required>
                <span class="valid_info_name"></span>
            </div>

            <div class="inputField">
                <input type="Email" name="email" id="email" value="${requestScope.user.email}" placeholder="Your email" required="" />
